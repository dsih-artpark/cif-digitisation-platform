...
def build_prompt() -> str:
    return "\n".join(
        [
            ...
            "   - patient_name must be the patient name as a readable string.",
            ...
            "   - location must be the broadest geography and village must be the local settlement when visible.",
            "   - if location and village are combined in one string, split them into location and village fields.",
            ...
            "   - temperature and hb_level must contain only the numeric value when visible.",
            "{",
            '  "patient_name": "string",',
            '  "age": "string",',
            '  "sex": "string",',
            ...
            "5) Translate non-English text into English where appropriate.",
            "6) If result is Negative, leave pathogen as an empty string.",
            "7) If multiple patient records appear, extract only the first or primary record.",
        ...
        "messages": [
            {
                ...
                "content": "\n".join(
                    [
                        ...
                        "5) Keep patient_name readable and in English transliteration when needed.",
