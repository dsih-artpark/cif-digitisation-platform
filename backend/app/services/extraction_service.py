...
def build_prompt() -> str:
    return "\n".join(
        [
            ...
            "   - location must be the broadest geography, district the next-level area, and village the local settlement when visible.",
            "   - if location is combined with district and village in one string, split them into location, district, and village fields.",
